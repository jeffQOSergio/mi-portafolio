...
if (w === 6) {
  ...
  if (w === 7) {
  contenido = [
    { nombre: "Infografía 1", archivo: "7_1.png" },
    { nombre: "Infografía 2", archivo: "7_2.png" },
    { nombre: "Infografía 3", archivo: "7_3.png" },
    { nombre: "Infografía 4", archivo: "7_4.png" }
  ];
  ...
  contenido = [
    ...
    { nombre: "Infografía Subtema 2", archivo: "s9_2.png" },
    { nombre: "Infografía Subtema 3", archivo: "s9_3.png" },
    { nombre: "Infografía Subtema 4", archivo: "s9_4.png" }
  ];
  ...
  if (w === 13) {
  contenido = [
    { nombre: "Tema 1", archivo: "s13_1.jpg" }
  ];

}
  if (w === 14) {
  contenido = [
    { nombre: "Tema 1", archivo: "s14_1.jpg" }
  ];

}
  if (w === 15) {
  contenido = [
    { nombre: "Tema 1", archivo: "s15_1.jpg" }
  ];

}
  if (w === 16) {
  contenido = [
    { nombre: "Tema 1", archivo: "s16_1.jpg" }
  ];
